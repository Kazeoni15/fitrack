...
export default function Create() {
  ...
  const save = ()=>{
    if(name =="" || mon.length < 1 || tue.length < 1 || wed.length < 1 || thu.length < 1 || fri.length < 1 || sat.length < 1 || sun.length < 1) {
      alert("Please fill out all the fields! Make sure you enter the title. If you don't want to schedule anything on a day, just enter 'Rest'.")
      return
